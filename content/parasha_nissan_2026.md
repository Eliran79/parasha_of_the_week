---
title: "הירח שנראה כמו ז' — ומה שהרמב\"ם ידע שגילתי עם עקרונות ARC"
parasha: "ראש חודש ניסן"
date: "2026-03-18"
tags: ["ירח", "רמב\"ם", "קידוש_החודש", "ARC", "מסגרת_ייחוס", "ניסן", "גאולה"]
emoji: "🌙"
excerpt: "05:04 בבוקר, כ\"ז אדר, ישראל. הירח נראה כמו ז' — אבל אנחנו בסוף החודש. משהו לא מסתדר. מרדיפת ההסבר הראשון עד הרמב\"ם — ומה שARC קורא מזה."
author: "אלירן סבג"
year: 2026
---

# הירח שנראה כמו ז' — ומה שהרמב"ם ידע שגילתי עם עקרונות ARC 
...
$$\text{תחום הכלל} = \{\text{ערב} \} \times \{\text{מערב}\} \times \{\text{ישראל}\}$$
...
$$\underset{\text{domain הכלל}}{\text{ג' בערב, מערב}} \xrightarrow{\text{טרנספורמציית מסגרת}} \underset{\text{אותו ירח, domain אחר}}{\text{ז' בבוקר, מזרח}}$$
...
$$S_{\text{observable}} \text{ (domain הכלל)} \subsetneq S_{\text{complete}} \text{ (כל מסגרות הייחוס)}$$
