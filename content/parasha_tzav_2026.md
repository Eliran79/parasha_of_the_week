...
$$\underbrace{\text{שגיאה על נתוני אימון}}_{\to 0} \quad \text{אבל} \quad \underbrace{\text{שגיאה על נתונים חדשים}}_{\to \infty}$$
...
$$\text{שגיאה כוללת} = \underbrace{\text{שגיאה על הנתונים}}_{\text{דיוק}} + \lambda \cdot \underbrace{\text{מורכבות המודל}}_{\text{קנס על סיבוכים מיותרים}}$$
