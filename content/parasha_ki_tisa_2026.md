...
שלמה המלך — החכם מכל האדם — לא הגיע לעומק החידה. אולי כי חיפש תשובה לוקאלית לכל צעד. אולי כי לא הגיע אל המסגרת הנכונה.

הוא שאל את השאלה הלא נכונה.

---

## הפרדוקס שעיקב את שלמה
...
$$\text{טמא}_{\text{אדם}} + \text{טהור}_{\text{כהן}} \xrightarrow{\text{פרה אדומה}} \text{טהור}_{\text{אדם}} + \text{טמא}_{\text{כהן}}$$
...
$$\underset{\text{לא}}{\text{הגיוני לוקאלית?}} \quad \neq \quad \underset{\text{כן}}{\text{עקבי גלובלית?}}$$
